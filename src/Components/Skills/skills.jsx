    ...
    <section id="skills">
      ...
      >
        <span className="skillDesc">
          ...
          strong understanding of design & development and a keen eye for
          details. I am proficient in HTML, CSS, JavaScript & Python.
        </span>
      </motion.div>
          ...
          <div className="skillBar" id="djangobg">
            ...
            <div className="skillBarText">
              ...
              <p>
                ...
                (JavaScript), Python (Django) & also Interact with databases
                using Mongoose.
              </p>
            </div>
          </div>
        ...
        >
          <div className="skillBar" id="apibg">
            ...
            <div className="skillBarText">
              ...
              <p>
                I create & use APIs that allow communication between the
                front-end and back-end, enabling data exchange and functionality
        ...
        >
          <div className="skillBar" id="deploybg">
            ...
            <div className="skillBarText">
              ...
              <p>
                I configure and manage servers to host web applications,
                websites & Deploy applications using platforms like Render,
                Netflify & other cloud services.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="skillBar" id="securitybg">
            ...
            <div className="skillBarText">
              ...
              <p>
                I implement security best practices to protect against common
                web vulnerabilities, such as SQL injection, and cross-site
        ...
        >
          <div className="skillBar" id="collabobg">
            ...
            <div className="skillBarText">
              ...
              <p>
                I work closely with designers, other developers, and
                stakeholders to understand project requirements and ensure
        ...
        >
          <div className="skillBar" id="troublebg">
            ...
            <div className="skillBarText">
              ...
              <p>
                I debug issues and troubleshoot problems that may arise during
